...
if(len(sys.argv)>5):
    print("using CLA")
    GAP,SEPARATION,VELOCITY,PIPE_VELOCITY,JUMP_VELOCITY, = [int(i) for i in sys.argv[1:]]
...
class Pipe():
    ...
    def set_height(self):
        ...
        :return: None
        """
        self.height = random.randrange(90, 660-self.GAP)
        self.top = self.height - self.PIPE_TOP.get_height()
        self.bottom = self.height + self.GAP

        print(self.bottom,self.top,self.height,self.PIPE_TOP.get_height())
...
def main():
    ...
    while True:
        ...
        if run:
            ...
            # for bird in birds:
            if bird.y + bird.img.get_height() - 10 >= FLOOR or bird.y < -20:
                run=False
